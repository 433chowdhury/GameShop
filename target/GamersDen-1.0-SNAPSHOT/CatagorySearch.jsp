<%-- 
    Document   : CatagorySearch
    Created on : Mar 27, 2018, 5:37:09 AM
    Author     : Tawhid
--%>
...
<li> <a href="ContactUs.jsp?pagename=CatagorySearch.jsp?search=<%=request.getParameter("search")%>">Contact Us</a></li>
...
<div class="row" style="width:100%;height:100px;"><!-- Row1 -->
    ...
    <%
        Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="SELECT * FROM games where catagory=\""+search+"\"";
