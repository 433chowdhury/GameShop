<%-- 
    Document   : Search
    Created on : Mar 26, 2018, 10:14:57 PM
    Author     : Tawhid
--%>
...
<li> <a href="ContactUs.jsp?pagename=GameSearch.jsp?search=<%=request.getParameter("search")%>">Contact Us</a></li>
...
<div class="row" style="width:100%;height:100px;"><!-- Row1 -->
    ...
    <%
        Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="SELECT * FROM games where gamename=\""+search+"\"";
            ResultSet rs=st.executeQuery(sql);
            int gameid=0;
            String picturename="empty";
            ...
            { 
                ...
                if(rs.getString("picturename")!=null)
                {
...
<footer class="container-fluid" style="width:100%;height:100px;">
    <p><center> All Rights Reserved</p></center><p>
</p><p><center><strong>GAMING FOREVER</strong></center></p>
</footer>
</div></div></body></html>
